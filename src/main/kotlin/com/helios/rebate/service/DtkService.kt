...
import com.helios.rebate.domain.const.DtkUrlConst
import com.helios.rebate.domain.dtk.DtkTwd2TwdData
import com.helios.rebate.domain.dtk.DtkTwd2TwdResp
import com.helios.rebate.domain.dtk.TbParseContentData
import com.helios.rebate.domain.dtk.TbParseContentResp
import com.helios.rebate.util.DtkApiClient
...
class DtkService {
    ...
    fun twd2twd(content: String): DtkTwd2TwdData? {
        ...
        paraMap["pid"] = pid
        val data: String = DtkApiClient.sendReq(url, appSecret, paraMap)
    ...
    fun tbMasterParse(content: String): TbParseContentData? {
        ...
        paraMap["appKey"] = appKey
        paraMap["content"] = content
        val data = DtkApiClient.sendReq(url, appSecret, paraMap) ?: return null
...
//        paraMap["logo"] = "xxxxx"
        return DtkApiClient.sendReq(url, appSecret, paraMap)
    }
...
//        paraMap["pageSize"] = "2"
        ...
        val data = DtkApiClient.sendReq(url, appSecret, paraMap)
        println(data)
    }
