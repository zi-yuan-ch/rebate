...
object HttpUtil {
    ...
    private val httpClient: CloseableHttpClient
        private get() {
            ...
            return HttpClients.custom()
                .setRetryHandler { exception: IOException?, executionCount: Int, context: HttpContext? ->
                    if (executionCount >= 1) { // Do not retry if over max retry count
    ...
    private fun getResult(request: HttpRequestBase): String {
        val httpClient: CloseableHttpClient? = httpClient
        var result = ""
        try {
